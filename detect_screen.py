...
class AsyncStream:
    def __init__(self, src, is_screen=False):
...
MONITOR_REGION = {"top": 0, "left": 0, "width": 960, "height": 1080}
...
def main():
    ...
    stream = AsyncStream(MONITOR_REGION, is_screen=True).start()
    ...
    while True:
        ...
        # Stage 1: YOLO26 — blocks briefly (~10ms on GPU)
        ...
        if SHOW_WINDOW:
            cv2.imshow('AI Censor - Screen', frame)
